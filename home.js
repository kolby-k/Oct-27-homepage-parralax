...
let container, camera, renderer, controls, title2;
let sceneL, sceneR;
...
function init() {
    ...
    title2 = document.getElementById('hideOnClick');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // This line triggers the transition
        slider.classList.remove('slider-hidden');
      });
      
    
    sceneL = new THREE.Scene();
    sceneL.background = new THREE.Color( '#ffffff' );

    sceneR = new THREE.Scene();
    sceneR.background = new THREE.Color( '#000000' );
    ...
    const light = new THREE.HemisphereLight( 0x99ff99, 0x999999, 3 );
